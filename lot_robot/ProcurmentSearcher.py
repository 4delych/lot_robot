...
class ProcurementSearcher:
    ...
    "ИТ-решения рассматриваются исключительно как инструмент реализации управленческих и организационных изменений. Компания не занимается изолированной разработкой, поставкой или сопровождением ИТ-продуктов без консалтинговой и трансформационной составляющей.\n\n"
    ...
    "— предоставление доступов, учётных записей, прав пользователей;\n"
